...
export const HowItWorks = () => {
    ...
    return (
        <section className="py-12 md:py-16 px-4">
            <div className="container mx-auto bg-linear-to-b from-[#FFFFFF] to-[#F3E5FF] p-10 w-full rounded-2xl border-2 border-[#EDD9FF]">
                {/* Header */}
                <div className="mb-12">
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-regular mb-3 text-black">
                        How it works
                    </h2>
                ...
                <div className="rounded-3xl p-8 md:p-10 relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-6 mb-8 relative">
                        {steps.map((step, index) => (
                            ...
                            >
                                ...
                                {/* Title */}
                                <h3 className="text-base md:text-lg font-medium text-gray-900 mb-2 leading-snug">
                                    {step.title}
                                </h3>
                    ...
                    <div className="flex justify-start md:justify-end">
                        <button className="bg-[#5E2A8C] hover:bg-purple-800 text-white px-6 py-3 rounded-lg flex items-center gap-2 transition-colors duration-200 font-medium">
                            Create Account
