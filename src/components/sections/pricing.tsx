            ...
            <div className="container mx-auto max-w-7xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 items-start">
                    {plans.map((plan, index) => (
                        <div
                            key={index}
                            className={`relative rounded-3xl p-8 md:p-10 min-h-[700px] flex flex-col ${
                                plan.isPopular
                                    ? "bg-gradient-to-b from-[#5E2A8C] to-[#1A0B26] text-white scale-105 shadow-2xl"
                        ...
                        >
                            ...
                            <div className="mb-8 pt-6">
                                ...
                                <div className="flex items-baseline mb-3">
                                    ...
                                    <span className={`text-xl md:text-2xl ml-1 ${
                                        plan.isPopular ? "text-purple-200" : "text-gray-600"
                                    }`}>
                                        {plan.period}
                                    </span>
                                </div>
                            ...
                            {/* Get Started Button */}
                            <button
                                className={`w-full py-4 px-6 rounded-xl font-semibold text-base transition-all duration-200 mb-5 ${
                                    plan.isPopular
                            ...
                            <div className={`h-px mb-8 ${
                                plan.isPopular ? "bg-purple-500/50" : "bg-purple-300"
                            }`}></div>
                                    ...
                                    {plan.features.map((feature, featureIndex) => (
                                        <li key={featureIndex} className="flex items-start gap-4">
                                            ...
                                            <div className={`flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center mt-0.5 ${
                                                plan.isPopular ? "bg-purple-500" : "bg-purple-600"
                                            }`}>
                                            ...
                                            <span className={`text-base leading-relaxed ${
                                                plan.isPopular ? "text-purple-100" : "text-gray-700"
                                            }`}>
                                                {feature.text}
                                            </span>
                                        </li>
