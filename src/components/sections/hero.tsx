  ...
  return (
    <section className="pt-32 pb-0 md:pt-48 px-4 bg-linear-to-b from-purple-50/30 to-purple-200/80 rounded-b-[3rem] overflow-hidden">
      <div className="container mx-auto text-left md:text-center max-w-6xl">
        <h1 className="text-4xl md:text-6xl font-regular tracking-tight mb-6 text-black/90">
      ...
      <div className="relative mt-16 md:mt-24 max-w-7xl mx-auto px-0">
        <div className="relative flex items-end justify-center">
          ...
          <div className="absolute left-0 md:left-4 lg:left-[-80px] xl:left-[-40px] bottom-0 md:bottom-4 lg:bottom-[-40px] xl:bottom-[50px] z-20 hidden md:block">
            <Image
              src={HeroImage2}
              alt="Wallet Image"
              width={300}
          ...
          <div className="absolute right-0 md:right-4 lg:right-[-80px] xl:right-[-40px] top-0 md:top-4 lg:top-[-40px] xl:top-[150px] z-20 hidden md:block">
            <Image
              src={HeroImage3}
              alt="Employee Image"
              width={300}
