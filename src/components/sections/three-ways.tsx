        ...
        <section className="py-16 md:py-24 px-4 bg-white">
            <div className="container mx-auto max-w-7xl">
                ...
                <div className="text-left md:text-center mb-16 md:mb-20">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl mb-4 text-gray-900 leading-tight md:max-w-4xl md:mx-auto font-regular">
                ...
                <div className="space-y-16 md:space-y-24">
                    {benefits.map((benefit, index) => (
                        ...
                        >
                            ...
                            >
                                <h3 className="text-2xl md:text-3xl lg:text-4xl font-medium mb-4 text-gray-900 leading-tight">
                                    {benefit.title}
                                </h3>
                            ...
                            >
                                <div className="w-full h-[300px] md:h-[350px] bg-gradient-to-br from-purple-100 to-purple-200 rounded-lg"></div>
                            </div>
                        </div>
                    ))}
                </div>
